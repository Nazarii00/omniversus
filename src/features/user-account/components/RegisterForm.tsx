...
import { signUpAction, signInWithProviderAction } from "../actions/authActions";
...
function validateUsername(username: string): FieldError {
  ...
  return (
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <p className={styles.subtitle}>Join the arena</p>
        ...
        >
          <label className={styles.field}>
            ...
            <input
              name="username"
              type="text"
              placeholder="fighter42"
              required
              autoComplete="username"
              className={usernameError ? styles.inputError : undefined}
              value={username}
              onChange={(e) => {
